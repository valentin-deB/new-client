      ...
      <Box className="l-container l-container--small">
        <Box
          ...
          >
            ...
            <Typography variant="h4" className="c-form__title">Details sur l'entreprise</Typography>
              <Controller
                name="companyName"
                control={control}
                defaultValue=""
            ...
            <Box display="flex" flexDirection="column" gap={2}>
              <Typography variant="h4" className="c-form__title">Personne de contact</Typography>
